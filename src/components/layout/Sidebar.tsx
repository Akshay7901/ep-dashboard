...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const SidebarContent = () => <div className="flex h-full flex-col bg-sidebar">
      {/* Logo */}
      <div className="h-16 border-b border-sidebar-border px-0 flex-row flex items-center justify-between mx-[5px]">
      ...
      {/* Navigation */}
      <nav className="flex-1 overflow-y-auto scrollbar-thin p-3 space-y-1 px-px py-px mx-0">

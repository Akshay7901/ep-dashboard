...
const statusColorMap: Record<string, { 
  ...
  contract_issued: { className: 'bg-[#BE185D] text-white hover:bg-[#BE185D] border-[#BE185D]', icon: FileCheck },
  contract_sent: { className: 'bg-[#BE185D] text-white hover:bg-[#BE185D] border-[#BE185D]', icon: FileCheck },

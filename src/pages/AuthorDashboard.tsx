          ...
          <div className="flex flex-wrap items-center gap-3">
            {Object.entries(statusSummary).map(([key, count]) => {
              ...
              const chipColorMap: Record<string, string> = {
                ...
                additional_info_required: "bg-[#D97706] text-white border-[#D97706]",
                additional_information_required: "bg-[#D97706] text-white border-[#D97706]",
                awaiting_more_info: "bg-[#D97706] text-white border-[#D97706]",
                feedback_and_agreement_pending: "bg-[#BE185D] text-white border-[#BE185D]",
                feedback_and_contract_issued: "bg-[#BE185D] text-white border-[#BE185D]",

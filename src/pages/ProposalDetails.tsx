...
const ProposalDetails: React.FC = () => {
  ...
  const { data: proposal, isLoading, error, refetch, isFetching } = useProposal(id || "");
    ...
    return (
      <DashboardLayout title="Proposal Details">
        <div className="text-center py-12 space-y-4">
          ...
          <p className="text-sm text-muted-foreground max-w-xl mx-auto break-words">{errorMessage}</p>
    ...
    <DashboardLayout title="Proposal Details">
      <div className="space-y-6">
          ...
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              {proposal.current_revision && (
                <span className="text-xs text-muted-foreground">Rev. {proposal.current_revision}</span>
              )}
            </div>
          ...
          <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    {proposal.file_uploads.split(",").map((url, index) => {
                      ...
                      const displayName = decodeURIComponent(
                        fileName.replace(/_/g, " ").replace(/\.docx$|\.pdf$|\.doc$/i, ""),
                      );
                      return (
                        <div
                          key={index}
                        ...
                        >
                          ...
                          <span className="text-foreground truncate flex-1">{displayName}</span>
                          {isPreviewable && (
                            <Button
                              variant="ghost"
                              size="sm"
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span
                      className={proposal.cv_submitted === "Yes" ? "text-primary font-medium" : "text-muted-foreground"}
                    >
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span
                      className={
                        proposal.sample_chapter_submitted === "Yes"
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span
                      className={
                        proposal.toc_submitted === "Yes" ? "text-primary font-medium" : "text-muted-foreground"
                      }
                    >
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-foreground">{proposal.permissions_required || "N/A"}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-muted-foreground">Permissions Docs</span>
                    <span className="text-foreground">{proposal.permissions_docs_submitted || "N/A"}</span>
                  </div>
            ...
            {proposal.under_review_elsewhere && (
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-foreground">{proposal.under_review_elsewhere}</p>
                </CardContent>
              </Card>
            )}
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    {proposal.job_title && <p className="text-xs text-muted-foreground mt-0.5">{proposal.job_title}</p>}
                    {proposal.institution && <p className="text-xs text-muted-foreground">{proposal.institution}</p>}
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-foreground break-all">{proposal.author_email}</p>
                    {proposal.secondary_email && proposal.secondary_email !== proposal.author_email && (
                      <p className="text-xs text-muted-foreground break-all">{proposal.secondary_email}</p>
                    )}
                  </div>
                </div>
                ...
                {proposal.address && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-foreground">{proposal.address}</p>
                    </div>
                  </div>
                )}
                ...
                {proposal.biography && (
                  <div className="pt-2 border-t border-border">
                    ...
                    <p className="text-sm text-foreground leading-relaxed">{proposal.biography}</p>
                  </div>
                )}
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                {proposal.sub_title && (
                  <div>
                    ...
                    <p className="text-sm font-medium text-foreground">{proposal.sub_title}</p>
                  </div>
                )}
                ...
                {proposal.book_type && (
                  <div>
                    ...
                    <p className="text-sm font-medium text-foreground">{proposal.book_type}</p>
                  </div>
                )}
                ...
                {proposal.keywords && (
                  <div>
                    ...
                    <p className="text-sm text-foreground">{proposal.keywords}</p>
                  </div>
                )}
                ...
                {proposal.word_count && (
                  <div>
                    ...
                    <p className="text-sm font-medium text-foreground">{proposal.word_count}</p>
                  </div>
                )}
                ...
                {proposal.expected_completion_date && (
                  <div>
                    ...
                    <p className="text-sm font-medium text-foreground">{proposal.expected_completion_date}</p>
                  </div>
                )}
                ...
                {proposal.co_authors_editors && (
                  <div>
                    ...
                    <p className="text-sm text-foreground">{proposal.co_authors_editors}</p>
                  </div>
                )}
              </CardContent>
            </Card>
                ...
                {proposal.ticket_number && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium font-mono text-foreground">{proposal.ticket_number}</p>
                    </div>
                  </div>
                )}
                ...
                {proposal.current_revision && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-foreground">{proposal.current_revision}</p>
                    </div>
                  </div>
                )}
                      ...
                      {proposal.contract_sent ? (
                        <span className="text-primary">
                          ...
                          {proposal.contract_sent_at &&
                            `on ${format(new Date(proposal.contract_sent_at), "MMM d, yyyy")}`}
                        </span>
                      ) : (
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <div>{proposal.ticket_number && <CommentsSection ticketNumber={proposal.ticket_number} />}</div>

...
export function buildContractSendPayload(fields: ContractSendFields) {
  ...
  return {
    ...
    author_copies: fields.authorCopies ?? "two copies",
    if_two_author_copies: fields.ifTwoAuthorCopies ?? "two copies",
    if_three_or_four_author_copies: fields.ifThreeOrFourAuthorCopies ?? "one copy",
